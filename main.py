...
def home():
    ...
    return render_template('index.html',links=reccs,links2=links2[7:13])
...
def high_rated():
    ...
    x_index=0
    y_index=6
    return  render_template('top-rated.html',data=high_rated_df,styles=btn_styles)
...
def all_books():
    return render_template('all-books.html',data=links2)
